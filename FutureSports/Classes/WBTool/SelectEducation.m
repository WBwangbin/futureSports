...
@interface SelectEducation ()<UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate>
{
...
@implementation SelectEducation
...
- (NSMutableArray *)weightArray {
    ...
    if (_weightArray == nil) {
        ...
        [_weightArray addObject:@"学霸"];
        [_weightArray addObject:@"博士以上"];
        [_weightArray addObject:@"博士"];
        [_weightArray addObject:@"硕士"];
        [_weightArray addObject:@"本科"];
        [_weightArray addObject:@"专科"];
        [_weightArray addObject:@"专科以下"];
        [_weightArray addObject:@"学渣"];
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        //picker默认值
        [_pickerView selectRow:weightIndex + 4 inComponent:0 animated:YES];
